...
Function GETPROD_AMAZONPARAM(href As String) As Object
    ...
    param.Add splitter(5) 'ASIN
    
    param.Add splitter(3) 'product description
...
Function GETREVIEWIDS(href As String) As Object
    ...
    'US_TOTAL_PAGE_REVIEWS = GETREVIEWSPAGESCOUNT(HTMLDocElements(30))
    ...
    '-------------------------------------------------------------------------------------------------------------
    'CRAWL THE NEXT REVIEW PAGES FOR ITS REVIEW ID'S
    '-------------------------------------------------------------------------------------------------------------
    ...
    For i = 2 To US_TOTAL_PAGE_REVIEWS
        ...
        'COLLECT'S THE ELEMENT WITH CLASS NAME THAT CONTAINTS THE REVIEW ID
